...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        print(extension,model_args.cache_dir)
        raw_datasets = load_dataset(
            extension,
    ...
    if model.config.decoder_start_token_id is None:
        print("<2"+str(data_args.target_lang)+">")
        model.config.decoder_start_token_id = tokenizer._convert_token_to_id_with_added_voc("<2"+str(data_args.target_lang)+">")
