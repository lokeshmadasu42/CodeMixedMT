...
echo 'done- 1: Parse the datasets'
...
echo 'done- 2: run spm_encode on the data'
...
echo 'done- 3: Build vocabulary for trimming'
...
--workers 70
echo 'done- 5: run fairseq-preprocess'
...
fairseq-train ${SCRATCH_DIR}/postprocessed/en-hi --encoder-normalize-before --decoder-normalize-before \
 ...
 --max-epoch 40 --max-tokens 512 --update-freq 2 --save-interval 1 --save-interval-updates 8000 --keep-interval-updates 10 \
